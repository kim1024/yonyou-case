  ...
  <div class="space-y-3">
    ...
    <div class="relative" ref="containerRef">
      ...
      <button
        ...
        @click="toggle"
      >
        <Building2 class="w-4 h-4 shrink-0" :class="selectedEnterprise ? 'text-[#DC2626]' : 'text-neutral-400'" :stroke-width="1.5" />
        ...
        >
          ...
          <div ref="optionsRef" class="flex-1 overflow-y-auto py-1.5 custom-scrollbar">
            <button
              ...
              :style="selectedEnterprise === name ? 'background: linear-gradient(90deg, rgba(220,38,38,0.06), transparent 40%); border-left: 2px solid; border-image: linear-gradient(to bottom, #DC2626, #EF4444) 1;' : ''"
              @click="selectItem(name)"
              @mouseenter="highlightedIndex = index"
            >
              <Building2
                class="w-3.5 h-3.5 shrink-0"
                :class="selectedEnterprise === name ? 'text-[#DC2626]' : 'text-neutral-400'"
                :stroke-width="1.5"
              />
