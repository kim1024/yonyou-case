...
.orb {
  ...
  background: radial-gradient(circle at 40% 40%, #6366F1, rgba(99, 102, 241, 0.3) 60%, transparent);
...
.orb-stage-2 {
  width: 68px;
  height: 68px;
  background: radial-gradient(circle at 40% 40%, #6366F1, #7C7FF7 40%, rgba(129, 140, 248, 0.2) 70%, transparent);
...
.orb-stage-3 {
  width: 72px;
  height: 72px;
  background: radial-gradient(circle at 40% 40%, #818CF8, rgba(129, 140, 248, 0.3) 60%, transparent);
