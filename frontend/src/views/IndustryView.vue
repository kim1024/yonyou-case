...
<template>
  <div>
    ...
    <div class="flex items-center justify-between mb-6">
      <h1 class="text-2xl font-bold text-gray-800">行业管理</h1>
      <button class="btn-primary" @click="handleAdd">新增行业</button>
    </div>
      ...
      <table class="w-full text-sm">
        <thead class="bg-gray-50">
          <tr>
            ...
            <th class="px-4 py-3 text-left text-gray-600">行业名称</th>
            <th class="px-4 py-3 text-left text-gray-600">所属专业</th>
            <th class="px-4 py-3 text-center text-gray-600">关联企业数</th>
        ...
        <tbody>
          <tr v-for="(item, index) in items" :key="item.id" class="border-t hover:bg-gray-50">
            ...
            <td class="px-4 py-3 text-gray-500">{{ item.major_name || '-' }}</td>
